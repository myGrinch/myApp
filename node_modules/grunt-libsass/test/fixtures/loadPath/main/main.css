/*
Error: File to import not found or unreadable: lib.
...
body:before {
  ...
  content: "Error: File to import not found or unreadable: lib.\A         on line 1 of main.scss\A \A 1: @import 'lib';\A 2: \A 3: .extendedThing {\A 4:     @extend .thing;\A 5:     background-color: $some-var;\A 6: }"; }
